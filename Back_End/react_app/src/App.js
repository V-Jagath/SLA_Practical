...
function App() {
  ...
  //   { id: 4, name: "siva", age: 20, dept: "testing", salary: 10000 },
  //   { id: 5, name: "karthi", age: 25, dept: "it support", salary: 10000 },
  // ]

  // const obj = { place: "chennai", temp: 40, climate: true };

  // const data = { name: "jagath", islogin: false };

  // const Data = [
  //   { rollNo: 1, Name: "Jagath", Grade: "A" },
  //   { rollNo: 2, Name: "Hari", Grade: "B" },
  //   { rollNo: 3, Name: "Suriya", Grade: "C" }];
